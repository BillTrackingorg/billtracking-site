...
- **Voting requires signing in with Google or Apple; reading never does.** The account's entire job is to make one vote per person per bill possible. Without it, the counts would be meaningless.
